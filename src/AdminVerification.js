...
export default function AdminVerification() {
  ...
  const loadUsers = async () => {
    const response = await fetch("http://localhost:8080/user/seeAllUsers");
  ...
  const deleteUser = async (id) => {
    ...
    loadUsers(); // Update user list after deleting
  };
                  ...
                  <TableCell>
                    <div className="flex">
                      ...
                      <Link
                        ...
                        to={`/lock/${students.id}`}
                        className="mr-4 text-red-400 hover:text-red-800"
                      >
                        <MdDelete size={25}/>
                      </Link>
                    </div>
